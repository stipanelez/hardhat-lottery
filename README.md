...
More comments (Croatian language) you can find in file natuknice.

I consider this way to be the best for learning.

I hope that my comments will help you when reading the code

_[⌨️ (13:41:02) Lesson 9: Hardhat Smart Contract Lottery](https://www.youtube.com/watch?v=gyMwXuJrbJQ&t=36048s)_
...
```
git clone https://github.com/stipanelez/hardhat-lottery
cd hardhat-lottery
yarn
```
